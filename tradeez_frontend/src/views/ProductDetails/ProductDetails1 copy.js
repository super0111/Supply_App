      ...
      {/* <Row gutter={[16, 16]} style={{ marginTop: 20 }}>
        <Col lg={{ span: 11 }} className="LeftSideBarmain">
          <div className="LeftSideBarmaincontainer">
            <img
              src={require("../../assests/images/ProductsImg/p13.png")}
              alt=""
            />
          </div>
          <div className="ProductSlider">
            ...
            <div className="rightArrowDesign">
              <div
                className="rightArrowDesignSquire"
                onClick={() => ref?.current?.next()}
              >
                <div className="imagecontainerMain">
                  <img
                    src={require("../../assests/images/ProductsImg/rightIcon.png")}
                  />
                </div>
              </div>
            </div>
        ...
        <Col className="rightSide" lg={{ span: 12, offset: 1 }}>
          <div>
            ...
            <p className="rightSideDescription">
              This grade of cement is used for plain concrete work and
              plastering works. It is suitable make concrete mix up to M30.
            </p>
            <p className="rightSidesubDescripotion">
              Cement is mainly used as a binder in concrete, which is a basic
              material for all types of construction, including housing, roads,
              schools, hospitals, dams and ports.
            </p>
          </div>
          {card ? (
            <div className="cartForm">
              ...
              >
                ...
                <Form.Item>
                  <Button type="primary" className="FormBtnQuote">
                    Quote
                  </Button>
                </Form.Item>
              </Form>
            ...
            <div>
              <div style={{ marginTop: 20 }} onClick={() => setCard(true)}>
                <Button size={"large"} className="BtnQuickQuote">
                  Quick quote
                </Button>
              </div>
          ...
          <div className="SpecificationForThisTeam">
            <p className="SpecificationForThisTeamTtile">
            ...
            <Row gutter={[16, 16]} style={{ marginTop: 20 }}>
              <Col lg={{ span: 12 }}>
                <Row gutter={[16, 16]}>
                  ...
                  <Col className="CementGradeDescription description">
                    {" "}
                    43 Grade{" "}
                  </Col>
                  <Col
                    className="packingSizeTitile title"
                    md={{ span: 11 }}
                    lg={{ span: 11 }}
                  >
                    {" "}
                  ...
                  <Col
                    className="packingSizeDescription description"
                    md={{ span: 10, offset: 3 }}
                    lg={{ span: 10, offset: 3 }}
                  >
                    {" "}
                  ...
                  <Col
                    className="packingTypeTitle title"
                    md={{ span: 12 }}
                    lg={{ span: 12 }}
                  >
                    {" "}
                  ...
                  <Col
                    className="packingTypeDescription description"
                    md={{ span: 10, offset: 2 }}
                    lg={{ span: 10, offset: 2 }}
                  >
                    {" "}
              ...
              <Col lg={{ span: 12 }}>
                <Row gutter={[16, 16]}>
                  <Col className="FormFactorTtile title" lg={{ span: 10 }}>
                    {" "}
                    Form Factor:{" "}
                  </Col>
                  <Col
                    className="FormFactorDescription description"
                    lg={{ span: 13, offset: 1 }}
                  >
                    Powder
                  </Col>
                  <Col className="SuitableForTtile title" lg={{ span: 10 }}>
                    {" "}
                    Suitable For:{" "}
                  </Col>
                  <Col
                    className="SuitableForDescripton description"
                    lg={{ span: 13, offset: 1 }}
                  >
                    {" "}
                    Indoor, Outdoor
                  </Col>
                  <Col className="UsedForTitile title" lg={{ span: 10 }}>
                    {" "}
                    Used For:{" "}
                  </Col>
                  <Col
                    className="UsedForTtile description"
                    lg={{ span: 13, offset: 1 }}
                  >
                    {" "}
                    All Purpose Cement
