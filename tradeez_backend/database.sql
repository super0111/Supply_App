...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44495 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `products_detail` (
  ...
  `suitableFor` varchar(20) DEFAULT NULL,
  `usedFor` varchar(20) DEFAULT NULL,
...
insert  into `products_detail`(`id`,`product_id`,`title`,`details1`,`grade`,`size`,`type`,`factor`,`suitableFor`,`usedFor`,`details2`) values 
(1,44464,'PPC Cement, 43 Grade, 25 Kg','This Grade Of Cement Is Used For Plain Concrete weork And Plasteriing Suitable Make Concrete Mix Up To M30.\r\n',43,25,'Paper Sack','Powder','Indoor, Outdoor','All Purpose Cement','asdfasdfasdfsadf'),
(2,44463,'PPC Cement, 43 Grade, 25 Kg','This Grade Of Cement Is Used For Plain Concrete weork And Plasteriing Suitable Make Concrete Mix Up To M30.\r\n',43,25,'aaa','ddd','eeee','aaaa','Cement is mainly used as a binder in concrete, which is a basic material for all types of construction, including housing, roads, schools, hospitals, dams and ports.'),
(3,44459,'asdfas','asdfasdfasdfasdfasdf',34,345,'fghd','sdf','dfhdfh','sdfhsdfh','sdfgsdfg'),
(4,44460,'asdf','asdfasdfasdfasdf',3,34,'sdfg','sdf','dfh','sdfgsdfgs','dfgsdfg'),
(5,44461,'asdfasdf','asdfasdfasdfasdf',234,4,'(NULsdfL)','sdf','sdfh','sdfg','fhsdfg'),
(6,44462,'asdfa','asdfasdfasdfasdf',346,1,'sdf','sdf','sdfh','sdjh','dfgsdfg'),
(7,44465,'asdf','asdfasdfasdf',65,34,'sdf','sdf','sdfh','ewty','sdfgsdfg'),
(8,44465,'hrgr','sdfasdfasdfasdf',2,5,'sdf','dfdhf','sfh','dfg','sdfgsdfg'),
(9,NULL,'asdf','fasdfasdfasdf',6,74,'sdf','dhf','sdfh','dfg','dfgsdfg'),
(10,NULL,NULL,NULL,54,34,'sdf','sdf','sdfh','dfg','sdfgsdfg'),
(11,NULL,NULL,NULL,NULL,34,'sdf','fdh',NULL,NULL,NULL);
